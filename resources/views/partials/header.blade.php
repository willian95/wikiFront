    ...
    <header class="header-shadow">
        <nav class='navbar navbar-expand-md navbar-fixed-js container'>
            <div class='flex-custom'>
                            ...
                            <ul id="ul" class="nav-fixed">
                                ...
                                <li class="nav-box_li user-menu_xs">
                                    <a @if(\Auth::user()->role_id == 2) href="{{ url('/teacher/profile') }}" @else href="{{ url('/institution/profile') }}" @endif class='nav-link pl-2 verse-row'>{{ \Auth::user()->name }}
                                        {{ substr(\Auth::user()->lastname, 0, 1) }}. <img alt='icon' class="teacher-icon mr-2" src="{{ url('assets/img/iconos/user-teacher.png') }}"></a>
                ...
                <div class='offcanvas-collapse fil flex-new ml-auto' id='navbarNav'>
                            ...
                            <div class="col-md-12 ">
                                <div class="menu-flex menu-flex_1">
                                    ...
                                    <li class='nav-item  flex-main'>
                                        ...
                                        <a @if(\Auth::user()->role_id == 2) href="{{ url('/teacher/profile') }}" @else href="{{ url('/institution/profile') }}" @endif class='nav-link pl-2 verse-row'>{{ \Auth::user()->name }}
                                            {{ substr(\Auth::user()->lastname, 0, 1) }}. <img alt='icon' class="teacher-icon mr-2" src="{{ url('assets/img/iconos/user-teacher.png') }}">
